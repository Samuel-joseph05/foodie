...
export default function BestSellers() {
  const bestSellers = [
    ...
    },
    {
      ...
      description: "Premium wagyu patty with aged cheddar and caramelized onions",
      price: 150,
    ...
    <section className="relative py-16 px-4 ">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="mb-12 text-center">
          <h2 className="mb-3 font-serif text-4xl font-bold text-balance">Best Sellers</h2>
          <p className="text-muted-foreground text-lg">Our most loved dishes, crafted with passion</p>
        </div>
            ...
            >
              <div className="relative aspect-4/3 overflow-hidden bg-muted">
                <Image
                  ...
                  alt={item.name} width={90} height={90}
                  className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105"
                />
              </div>

              <div className="p-5">
                <h3 className="mb-2 font-semibold text-lg text-balance">{item.name}</h3>
                <p className="mb-4 text-muted-foreground text-sm text-pretty">{item.description}</p>
